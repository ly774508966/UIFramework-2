...
public class UIInfos
{
    ...
    public static UICoreData UI_TypePop = new UICoreData(UIRootType.PopUp, UIShowModel.DoNoting, UIColliderType.Penetrate, UINavigationMode.IngoreNavigation, false, true);
    ...
    // Tips弹出式UI (同类型互斥，物品tips，不会隐藏当前任何UI，全透明模态窗口)
    public static UICoreData UI_TypeTips = new UICoreData(UIRootType.SecondPopUp, UIShowModel.TypeMutex, UIColliderType.Lucency, UINavigationMode.IngoreNavigation, false, true, false);
